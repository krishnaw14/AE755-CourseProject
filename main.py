...
def main():
	...
	parser.add_argument('--data', type=str, default='mnist',choices=['mnist', 'taxi_time', 'devanagari'], required=True)
	...
	parser.add_argument('--visualize_eval', action='store_true', default=False)
